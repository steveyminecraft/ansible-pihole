...
class MoleculeTraefikScenarioTests(unittest.TestCase):
    def test_debian_traefik_scenario_enables_supplied_tls(self) -> None:
        ...
        self.assertEqual(molecule["scenario"]["name"], "debian-traefik")
        self.assertEqual(
