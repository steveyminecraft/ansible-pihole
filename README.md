...
- [`updates`](roles/updates/tasks/main.yml), [`sshd`](roles/sshd/tasks/main.yml), [`geerlingguy.docker`](https://galaxy.ansible.com/geerlingguy/docker) ([upstream](https://github.com/geerlingguy/ansible-role-docker); installed via [`roles/requirements.yml`](roles/requirements.yml)), [`unbound`](roles/unbound/tasks/main.yml), [`pihole_compat`](roles/pihole_compat/handlers/main.yml) (handler shim for vendored [`pihole`](roles/pihole/tasks/main.yml)), [`pihole`](roles/pihole/tasks/main.yml) (often from Galaxy; see [`roles/requirements.yml`](roles/requirements.yml)), [`keepalived`](roles/keepalived/tasks/main.yml), [`start_keepalived`](roles/start_keepalived/tasks/main.yml) / [`stop_keepalived`](roles/stop_keepalived/tasks/main.yml) as used in the play.
